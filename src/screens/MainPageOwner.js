...
export default function MainPageOwner({ navigation }) {
  ...
  const navigateToBranchDetail = (sucursalId) => {
    navigation.navigate('BranchesDetail', { sucursalId: sucursalId });
  };
  ...
  return (
    <ScrollView contentContainerStyle={{ alignItems: 'center' }} style={{ backgroundColor: 'rgb(17 24 39)', flex: 1 }}>
      ...
      <FlatlistMovies branches={branches} onPressItem={navigateToBranchDetail} />
    </ScrollView>
  );
}
